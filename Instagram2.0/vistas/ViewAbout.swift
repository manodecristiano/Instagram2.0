...
var listaPersona:[Persona] = [
    ...
    Persona(descripcion: "Tatuador, en mi tiempo libre me gusta aprender cosas nuevas y que esten relacionadas con el diseño, por eso aprendi por mi cuenta a tatuar.Llevo desde el 2015.", imagen: "tatuador"),
    ...
    Persona(descripcion: "Nuca. He tenido varios perros a lo largo de mi vida, peró ninguno me hizo sentir como un padre, la perdida de ella fue algo amargo, creo y me gusta creerlo que se fué cuando vio que ya iba por buen camino. Se fue el 5 de abril de 2018", imagen: "nukaANDyo.png")]
...
class ViewAbout : UIViewController , UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableViewAbout: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       ...
       // myCell.separatorView.isHidden = indexPath.row == 2
    ...
    override func viewDidLoad() {
        ...
        tableViewAbout.backgroundColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
    }
